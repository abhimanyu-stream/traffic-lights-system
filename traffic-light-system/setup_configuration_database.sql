-- Execute this script in your MySQL client to set up configuration tables
-- Connect to MySQL: mysql -u root -proot -h localhost -P 3306
...
SELECT 'Configuration Tables Created:' as status;
